...
namespace LogMaintenance
{
...

    {
        ...
        private static void UploadLog4Net()
        {
            ...
            var outputFile = @"d:\home\logfiles\processed\" + MapBase + "\\UploadLog4Net.txt";
        ...
        private static void UploadIIS()
        {
            ...
            var outputFile = @"d:\home\logfiles\processed\" + MapBase + "\\UploadIIS_" + myTimeStamp.ToString().Replace("/", "_").Replace(":", "_") + ".txt";
