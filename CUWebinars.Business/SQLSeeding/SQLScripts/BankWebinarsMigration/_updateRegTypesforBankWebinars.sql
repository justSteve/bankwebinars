...
WHERE   idWebinar IN ( 
SELECT idWebinar FROM dbo.Webinar WHERE Status = 2 AND Duration = 2
 )
...
WHERE   idWebinar IN ( 
SELECT idWebinar FROM dbo.Webinar WHERE Status = 2 AND Duration = 1
 )
...
WHERE   idWebinar IN ( 
SELECT idWebinar FROM dbo.Webinar WHERE Status = 3 AND Duration = 1
 )
...
WHERE   idWebinar IN ( 
SELECT idWebinar FROM dbo.Webinar WHERE Status = 3 AND Duration = 2
 )
--SELECT  *
--FROM    BankWebinars.dbo.RegTypesGroupsXref groupXRef
--        INNER JOIN BankWebinars.dbo.RegTypesGroups rGroup ON groupXRef.idRegTypeGroup = rGroup.idRegTypeGroup
...
SET     RegTypeLabel = 'Live Plus Six' ,
        RegTypeExplain = 'Attend live plus 6 <i>months</i> access to OnDemand playback. Combine the advantages of live attendance with an unlimited number of replays for the next six months.',
		SortOrder = 4
WHERE   idRegType = 207
...
UPDATE  dbo.RegType
SET     RegTypeLabel = (SELECT RegTypeLabel FROM BankWebinars.dbo.RegType WHERE idRegType = 205) ,
        RegTypeExplain =  (SELECT RegTypeExplain FROM BankWebinars.dbo.RegType WHERE idRegType = 205) 
WHERE   idRegType = 200


UPDATE  dbo.RegType
SET     RegTypeLabel = (SELECT RegTypeLabel FROM BankWebinars.dbo.RegType WHERE idRegType = 206) ,
        RegTypeExplain =  (SELECT RegTypeExplain FROM BankWebinars.dbo.RegType WHERE idRegType = 206) 
WHERE   idRegType = 201



UPDATE  dbo.RegType
SET     RegTypeLabel = (SELECT RegTypeLabel FROM BankWebinars.dbo.RegType WHERE idRegType = 207) ,
        RegTypeExplain =  (SELECT RegTypeExplain FROM BankWebinars.dbo.RegType WHERE idRegType = 207) 
WHERE   idRegType = 203

UPDATE  dbo.RegType
SET     RegTypeLabel = (SELECT RegTypeLabel FROM BankWebinars.dbo.RegType WHERE idRegType = 208) ,
        RegTypeExplain =  (SELECT RegTypeExplain FROM BankWebinars.dbo.RegType WHERE idRegType = 208) 
WHERE   idRegType = 202

UPDATE  dbo.RegType
SET     RegTypeLabel = (SELECT RegTypeLabel FROM BankWebinars.dbo.RegType WHERE idRegType = 209) ,
        RegTypeExplain =  (SELECT RegTypeExplain FROM BankWebinars.dbo.RegType WHERE idRegType = 209) 
WHERE   idRegType = 204
