...
IF NOT EXISTS ( SELECT  *
    ...
    BEGIN
        ...
        (
          ...
          CONSTRAINT [PK_Options] PRIMARY KEY CLUSTERED ( [idRegType] ASC )
        )
            ON
        [PRIMARY] 
    END
...
IF NOT EXISTS ( SELECT  *
    ...
    BEGIN
        ...
        (
          [idRegTypesXref] [int] IDENTITY(1, 1)
                                NOT NULL ,
          [idRegTypeGroup] [int] NOT NULL ,
          [idRegType] [int] NOT NULL ,
          CONSTRAINT [PK_OptionsXref] PRIMARY KEY CLUSTERED ( [idRegTypesXref] ASC )
        )
            ON
        [PRIMARY]
    END
...
INSERT  INTO [dbo].[Options]
        ...
        SELECT  [idRegType] ,
                ...
                [optionLabel] ,
                [priceToAdd] ,
                --(SELECT SKU FROM TTSWebinars2_testing.dbo.Options WHERE [TTSWebinars2].[dbo].[Options].idRegType = TTSWebinars2_testing.dbo.Options.idRegType),
                [percToAdd] ,
                [sortOrder] ,
                [type] ,
				--,
