...
PRINT '---------> importing: ' + CAST (@importCount AS VARCHAR)
        INSERT  INTO CUWebinars.dbo.Discount
                ( discountType ,
                  DiscountCode ,
                  percentOff ,
                  flatOff ,
...
PRINT 'following statements generated via C:\Users\Steve\Source\Repos\CUWebinars\CUWebinars.Business\SQLSeeding\SQLScripts\CUWebinarsMigration\PopulateCPSubscriptions.sql'
SET NOCOUNT ON 
SET NOCOUNT ON
