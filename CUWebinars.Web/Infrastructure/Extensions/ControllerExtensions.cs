...
namespace CUWebinars.Web.Infrastructure.Extensions
{
    ...
    {
        public static ActionResult JsonNet(this Controller controller, ModelStateDictionary state)
        {
            ...
            return controller.JsonNet(false, "There have been some errors", errorsDictionary);
        }
