    ...
    setCalendar: function (id, startOnMonday, limits) {
        try {
            ...
            if ($('lite_mode_' + id)) {
                ...
                /*Combined multiple code block definition*/
                ...
                $('lite_mode_' + id).observe('keyup', function (e) {
                    e.stopPropagation();
                    /*Dogus: check keycode on keyup, if it is a numeric key, set new date value and run handler*/
                    if ((e.keyCode >= 48 && e.keyCode <= 57) || (e.keyCode >= 96 && e.keyCode <= 105)) {
                        e.currentTarget.dateChanged(e, calendar);
                    }
                    else {
                        console.log("immediate propogation stop");
                        e.preventDefault();
