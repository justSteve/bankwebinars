    ...
    (function (_menu) {
        ...
        var wijmenu = (function (_super) {
            ...
            wijmenu.prototype._create = function () {
                ...
                ele.data("wijmomenu", self.widgetFullName);
            ...
            wijmenu.prototype._createMenuItems = function () {
                ...
                if (o.ensureSubmenuOnBody && o.mode === "flyout") {
                    ...
                    itemContainer = $("<ul>").addClass(o.wijCSS.wijmenuList).addClass(o.wijCSS.helperReset).data(self.widgetFullName, self).data("wijmomenu", self.widgetFullName);
                }
            ...
            wijmenu.prototype._createDisabledDiv = function (outerEle) {
                return $("<div></div>").addClass(this.options.wijCSS.stateDisabled).css({
                    // fix bug 109700 wijdialog and wijpopup's zindex is base on 1000, so set this to 999.
                    "z-index": "999",
                    position: "absolute",
                    width: "100%",
                    height: "100%",
            ...
            */
            wijmenu.prototype.nextPage = function (event) {
                var self = this, activeEle = self._getActiveItemElement(), base, height, result, widget, itemToActivate;

                if (activeEle) {
                    widget = self.activeItem._getParentOrMenu();
                } else {
                    widget = self;
                    itemToActivate = self._getFirstSelectableSubItem();
                    activeEle = itemToActivate && itemToActivate.element;
                }

                if (self.options.mode === "sliding" && self._hasScroll()) {
                    if (!activeEle || self.last()) {
                        self.activate(event, widget._getFirstSelectableSubItem());
                        return;
                    }
                    base = activeEle.offset().top;
            ...
            */
            ...
            wijmenu.prototype._setOption = function (key, value) {
                var self = this;
            ...
            wijmenu.prototype._innerDisable = function () {
                _super.prototype._innerDisable.call(this);
                this._handleDisabledOption(true, this.domObject.menucontainer);
            };

            wijmenu.prototype._innerEnable = function () {
                _super.prototype._innerEnable.call(this);
                this._handleDisabledOption(false, this.domObject.menucontainer);
            };
            ...
            wijmenu.prototype._set_submenuTriggerEvent = function (value) {
                var self = this, o = self.options;

                o.submenuTriggerEvent = value;
                if (o.mode === "flyout") {
                    self._killFlyout();
                    self._flyout();
                }
            ...
            wijmenu.prototype._set_maxHeight = function (value) {
                var self = this, o = self.options;
                if (o.mode === "sliding") {
                    o.maxHeight = value;
                    self._sroll();
            ...
            wijmenu.prototype._bindMousehoverEvent = function (element) {
                ...
                element.delegate("li>." + o.wijCSS.wijmenuLink, "mouseenter.wijmenuEvent", function () {
                    ...
                    if (self._isDisabled() || itemDisabled) {
                        return;
                    }
            ...
            */
            wijmenu.prototype.refresh = function () {
                ...
                if (self._isDisabled()) {
                    self._handleDisabledOption(true, self.domObject.menucontainer);
                }
            ...
            wijmenu.prototype._resetScroll = function (widget) {
                var self = this, mycontainer = self._rootMenu.parent(), fixPadding = 5, scrollcontainer = self.domObject.scrollcontainer, sublist = widget._getSublist(), activeEle = document.activeElement;

                // When the _resetScroll function is invoked, it means current menu will slider to its child or parent menu.
                // So there is no need to make the active element of current menu get focus in the super panel.
                if (activeEle && self.element.find(activeEle)[0]) {
                    $(activeEle).blur();
                }
            ...
            wijmenu.prototype._resetDrilldownMenu = function (breadcrumb, callback) {
                ...
                ele.animate({ left: 0 }, o.showDuration, null, function () {
            ...
            wijmenu.prototype._drilldown = function () {
                ...
                ele.addClass(o.wijCSS.wijmenuContent).addClass(o.wijCSS.wijmenuCurrent).addClass(o.wijCSS.content).addClass(o.wijCSS.helperClearFix).css({ width: containerWidth });
                    ...
                    if (o.backLink) {
                        if (footer.find('a').length === 0) {
                            ...
                            self._backLink = $('<a href="#"></a>').append(backlinkIcon).append(backlinkText).appendTo(footer).click(function (e, callback) {
                                ...
                                ele.stop(true, true);
                                if (direction === "rtl") {
                                    prevLeftVal = Math.round(parseInt(ele.css('left').replace("px", ""))) - Math.round(container.width());
                                } else {
                                    prevLeftVal = Math.round(parseInt(ele.css('left').replace("px", ""))) + Math.round(container.width());
            ...
            wijmenu.prototype._slidingAnimation = function (ele, left, callback) {
                ...
                if (o && !o.disabled) {
                    ele.stop(true, true).animate({ left: left }, o.duration, o.easing, callback);
                } else {
                    ele.css("left", left);
                    callback.call(this);
                }
            ...
            wijmenu.prototype._killDrilldown = function () {
                var ele = this._getSublist(), o = this.options, domObject = this.domObject, style = { width: "", height: "" };
            ...
            wijmenu.prototype._displayMenu = function (e) {
                ...
                showAnimation = $.extend({}, { option: { direction: direction } }, o.animation, o.showAnimation);
            ...
            wijmenu.prototype._setPosition = function (triggerEle) {
                var pOption = this._getPosition(), obj = { of: triggerEle }, menuContainer = this.domObject.menucontainer;
            ...
            */
            wijmenu.prototype.remove = function (index) {
            ...
            wijmenu._animateFlyoutMenu = function (showAnimation, animationOptions, callback) {
            ...
            wijmenu._getMenuItemOptions = function (options, index) {
                if (!options) {
                    return {};
                }
            ...
            wijmenu._getOuterElement = function (selector, isInnerSelector) {
                return $(selector).filter(function () {
                    return $(this).closest(isInnerSelector).length === 0;
                });
            };

            wijmenu._hasVisibleSubMenus = function (widgetElement) {
                var widget, items, i;
            ...
            wijmenu._getFirstSelectableSubItem = function (widget) {
            ...
            wijmenu._getLastSelectableSubItem = function (widget) {
            ...
            wijmenu._getSelectableSubItems = function (widget, filter) {
            ...
            /** Adds a child menuItem to the menuItem.  */
            wijmenu._add = function (self, menuItem, position) {
            ...
            wijmenu._changeCollection = function (idx, menuItems, items, menuItemWidget) {
                if (!menuItemWidget) {
            ...
            wijmenu._remove = function (self, index) {
            ...
            wijmenu._getItemWidget = function (li) {
        ...
        var wijmenu_options = (function () {
            function wijmenu_options() {
                ...
                * If submenuTriggerEvent is 'default', it will get value from triggerEvent option.
                * @remarks The value can be seted to 'default', 'click', 'mouseenter', 'dbclick', 'rtclick'.
                */
                this.submenuTriggerEvent = "default";
                ...
                * from jQuery.UI.
                */
                this.animation = { animated: "slide", duration: 400, easing: null, option: null };
                ...
                * from jQuery.UI.
                */
                this.hideAnimation = { animated: "fade", duration: 400, easing: null, option: null };
                ...
                */
                ...
                this.slidingAnimation = { duration: 400, easing: null };
        ...
        //#region menu options
        wijmenu.prototype.options = $.extend(true, {}, wijmo.wijmoWidget.prototype.options, new wijmenu_options());
        ...
        /** @ignore*/
        (function (MarkupType) {
            MarkupType[MarkupType["link"] = 0] = "link";
            MarkupType[MarkupType["separator"] = 1] = "separator";
            MarkupType[MarkupType["header"] = 2] = "header";
            MarkupType[MarkupType["other"] = 3] = "other";
        })(_menu.MarkupType || (_menu.MarkupType = {}));
        var MarkupType = _menu.MarkupType;
        ...
        var wijmenuitem = (function (_super) {
            ...
            wijmenuitem.prototype._create = function () {
                ...
                self.element.data("wijmomenuitem", self.widgetFullName);
            ...
            wijmenuitem.prototype._set_iconClass = function (value, writeOnly) {
                ...
                if (self._getMenuItemType() === 3 /* other */) {
            ...
            wijmenuitem.prototype._set_separator = function (value, writeOnly) {
                ...
                if (writeOnly && value === false) {
                    ...
                    self._createMenuItemMarkup(0 /* link */).appendTo(ele);
                } else if (value === true || link.length === 0) {
                    o.separator = true;
                    o.header = false;
                    ele.html(self._createMenuItemMarkup(1 /* separator */));
                } else {
                    o.separator = false;
                }
            };
            ...
            wijmenuitem.prototype._set_header = function (value, writeOnly) {
                ...
                if (writeOnly && value === false) {
                    ...
                    if (!link.is("h1,h2,h3,h4,h5")) {
                        ...
                        link.remove();
                        link = self._createMenuItemMarkup(2 /* header */);
                        ele.append(link);
                    }
                } else {
                    o.header = false;
            ...
            wijmenuitem.prototype._createItemWidget = function ($li, options) {
                ...
                //Fix for jQuery UI 1.10
                return $li.data(self.widgetFullName);
            };
            ...
            wijmenuitem.prototype._getItemTriggerEvent = function () {
                var self = this, ele = self.element, menu = self._getMenu(), o = menu.options, triggerEvent = o.submenuTriggerEvent;
                ...
                if (o.trigger !== "") {
                    ...
                    } else if (triggerEvent === "default") {
                        if (menu.element.is(o.trigger)) {
                            triggerEvent = o.triggerEvent;
                        } else {
            ...
            wijmenuitem.prototype._flyout = function () {
                ...
                if (self.getItems().length > 0) {
                    ...
                    if (triggerEvent !== "default" && triggerEvent !== "mouseenter") {
                        switch (triggerEvent) {
                            case "click":
                                link.on("click" + nameSpace, function (e) {
                                    if (self._isDisabled() || $(this).hasAllClasses(o.wijCSS.stateDisabled)) {
                                        return;
                                    }
                ...
                link.on("click.wijmenuEvent", function (e) {
                    ...
                    if (link.is("a")) {
                        ...
                        } else if (!(o.trigger !== "" && li.data("triggerEvent") !== "default" && li.data("triggerEvent") !== "mouseenter")) {
                            menu._hideAllMenus(e);
                        } else {
                            var curList = menu._currentMenuList, j;
            ...
            wijmenuitem.prototype._setMenuItemPosition = function () {
                var self = this, sublist = self._getSublist(), pOption = self._getMenuItemPosition(), obj = { of: this._getLink() };
            ...
            wijmenuitem.prototype._innerDestroy = function (invokedByParent) {
                ...
                item.children("ul").removeClass(o.wijCSS.wijmenuList).removeClass(o.wijCSS.content).removeClass(o.wijCSS.cornerAll).removeClass(o.wijCSS.helperClearFix).removeClass(o.wijCSS.wijmenuChild).removeClass(o.wijCSS.helperReset).attr("role", "").attr("aria-activedescendant", "").show().css({ left: "", top: "", position: "" }).attr("hidden", "");
            ...
            /** Remove an item from the menu.*/
            wijmenuitem.prototype.remove = function (index) {
                wijmenu._remove(this, index);
            };

            /** set the bounds for the frame by the bounds and box-shadow setting of the sub menu */
            wijmenuitem.prototype._setIframeBounds = function (sublist, frame) {
            ...
            /** Parse string setting to number */
            wijmenuitem.prototype._parsePxToNumber = function (px) {
        ...
        _menu.wijmenuitem = wijmenuitem;

        var wijmenuitem_options = (function () {
            function wijmenuitem_options() {
                /** Selector option for auto self initialization.*/
                this.initSelector = ":jqmData(role='wijmenuitem')";
                /** wijmenu css, extend from $.wijmo.wijCSS.*/
                this.wijCSS = {
                ...
                */
                ...
                /** A value that determines whether  the item has beend selected.*/
                this.selected = false;
                /** The options of child items.*/
                this.items = null;
            }
            return wijmenuitem_options;
        })();

        wijmenuitem.prototype.options = $.extend(true, {}, wijmo.wijmoWidget.prototype.options, new wijmenuitem_options());
