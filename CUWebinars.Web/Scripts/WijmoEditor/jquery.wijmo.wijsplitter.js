    ...
    (function (splitter) {
        ...
        var wijsplitter = (function (_super) {
            ...
            wijsplitter.prototype._setOption = function (key, value) {
                var self = this, o = self.options, expander, oldValue = $.extend({}, o[key]);
            ...
            wijsplitter.prototype._innerDisable = function () {
                _super.prototype._innerDisable.call(this);
                this._handleDisabledOption(true, this.element);
            };

            wijsplitter.prototype._innerEnable = function () {
            ...
            wijsplitter.prototype._create = function () {
                ...
                if (self.element.wijAddVisibilityObserver) {
                    self.element.wijAddVisibilityObserver(function () {
                        //if the splitter in dialog, but dialog is minimize, the element is still hidden.
            ...
            */
            ...
            wijsplitter.prototype._createDisabledDiv = function (outerEle) {
                var self = this, ele = outerEle ? outerEle : self.element, eleOffset = ele.offset(), disabledWidth = ele.outerWidth(), disabledHeight = ele.outerHeight(), css = {
                    "z-index": "99999",
                    position: "absolute",
                    width: disabledWidth,
            ...
            wijsplitter.prototype._splitterify = function () {
                var self = this, element = self.element, o = self.options, fields = self._fields, wrapper, bar, expander, icon, pnl1 = { n: undefined, content: element.find(">div:eq(0)") }, pnl2 = { n: undefined, content: element.find(">div:eq(1)") };
            ...
            wijsplitter.prototype._updateExpanderCss = function () {
                var self = this, o = self.options, fields = self._fields, expander = fields.expander, icon = fields.icon, css = o.wijCSS, cornerPre = css.cornerCssPrefix, isVertical = o.orientation === "vertical", panel2IsCollapsing = o.collapsingPanel !== "panel1", cssPrefix = isVertical ? css.vSplitterCssPrefix : css.hSplitterCssPrefix, ovalue = (isVertical ? 1 : 0) * 2 + (panel2IsCollapsing ? 1 : 0), collapsedExpCorner1Css = ["bl", "tr", "tr", "bl"][ovalue], collapsedExpCorner2Css = ["br", "tl"][+panel2IsCollapsing], collapsedIconCss = [
                    css.iconArrowDown, css.iconArrowUp,
                    css.iconArrowRight, css.iconArrowLeft][ovalue], expandedExpCorner1Css = ["tr", "bl", "bl", "tr"][ovalue], expandedExpCorner2Css = ["tl", "br"][+panel2IsCollapsing], expandedIconCss = [
                    css.iconArrowUp, css.iconArrowDown,
                    css.iconArrowLeft, css.iconArrowRight][ovalue];
            ...
            wijsplitter.prototype._initResizer = function () {
                ...
                if (o.orientation === "vertical") {
                    ...
                    fields.panel1.n.resizable({
                        ...
                        // strange behavior, maybe the animate option in jQuery ui resizable has an behavior.
                        // use another option instead of it.
                        disabledAnimate: animation.disabled,
                    ...
                    fields.panel1.n.resizable({
                        ...
                        start: function () {
                            ...
                            var iframe1 = fields.panel1.content.children("iframe")[0];
                            if (iframe1) {
                                self._addTransparentDivForIframe(iframe1, fields.panel1);
                            }
                            var iframe2 = fields.panel2.content.children("iframe")[0];
                            if (iframe2) {
            ...
            wijsplitter.prototype._setPanelsScrollMode = function () {
                var self = this, fields = self._fields, o = self.options, pnlScrollBars = [o.panel1.scrollBars, o.panel2.scrollBars];
        ...
        wijsplitter.prototype.options = $.extend(true, {}, wijmo.wijmoWidget.prototype.options, new wijsplitter_options());
        ...
        if (!wijsplitter.prototype._isMobile && $.ui != null && $.ui.plugin != null) {
            $.ui.plugin.add("resizable", "wijanimate", {
                stop: function (event, ui) {
                    var self = $(this).data("ui-resizable"), o = self.options, element = self.element, pr = self._proportionallyResizeElements, ista = pr.length && (/textarea/i).test(pr[0].nodeName), soffseth = ista && $.ui.hasScroll(pr[0], 'left') ? 0 : self.sizeDiff.height, soffsetw = ista ? 0 : self.sizeDiff.width, style, left, top;
