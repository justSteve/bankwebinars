//// replaced by grid editor MANAGE namespace
...
//            }
//        }).fail(function (data) {
//            $('#orderRelatedFields').html('<div class="text-error">There has been a transport-level error, please use our Help & Feedback button (lower right corner)  for immediate assistance.</div>');
//        });
//    };
...
//            if (status === 'error') {
//                $(this).html('<div id="errorDiv" class="text-error">There has been an error at the server, please use our Help & Feedback button (lower right corner)  for immediate assistance. <br />' + (xhr.statusText === 'Internal Server Error' ? '' : xhr.statusText) + '</div>');
//            } else {
