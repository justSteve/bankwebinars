...
jQuery(document).ready(function($) {
    ...
    //        var flickr_limit = $(this).data('flickr-limit') ? $(this).data('flickr-limit') : 12;
    //        var flickr_tags = $(this).data('flickr-tags') ? $(this).data('flickr-tags') : '';
    //        var flickr_tagmode = $(this).data('flickr-tagmode') ? $(this).data('flickr-tagmode') : 'any';
