...
{
    public class CalendarRssDTOAssembler : IDTOAssembler<CalendarRssDTO, Webinar>
    {
        ...
        public CalendarRssDTO Entity2DTO(Webinar entity)
        {
            ...
            var dto = new CalendarRssDTO
            {
                ...
                Content = entity.Date.ToShortDateString()+ " - " + entity.Date.ToShortTimeString()  + entity.Description
        ...
        public IList<CalendarRssDTO> Entities2DTOs(IList<Webinar> entities)
        {
            ...
            var dtoAssembler = new CalendarRssDTOAssembler();
