...
namespace CUWebinars.Web.Core
{
    ...
    /// <summary>
    /// from: https://www.echosteg.com/jquery-datatables-asp.net-mvc5-server-side
    /// A full result, as understood by jQuery DataTables.
    /// </summary>
    /// <typeparam name="T">The data type of each row.</typeparam>
    public class DataTableService<T>
    {
        /// <summary>
        ...
        /// rather than simply echoing back to the client what it sent in the draw parameter, in order to prevent 
    ...
    public abstract class DTRow
    {
        ...
        /// <summary>
        /// Add this data property to the row's dt-tag tr node allowing abstract data to be added to the node, 
        /// using the HTML5 data-* attributes.
        /// This uses the jQuery data() method to set the data, which can also then be used for later 
        /// retrieval (for example on a click event).
        /// </summary>
    ...
    public class DTParameters
    {
        /// <summary>
        /// Draw counter.
        /// This is used by DataTables to ensure that the Ajax returns from server-side processing requests are
        ...
        /// <summary>
        /// An array defining how many columns are being ordering upon - i.e. if the array length is 1, 
    ...
    public class DTParametersOrders : DTParameters
    {
